...
def run_HO_1D_simulation():
    # Domain setup
    L, dx = 200, 0.15  # Spatial parameters
    ...
    ho = HarmonicOscillator(
        HarmonicConfig(x_0=np.zeros(dim), V_0=1, dim=1, omega=100))
    ...
    # Visualize results
    reader = SimulationReader("results/wall_1D.h5")
    ...
    reader.animate_solution(
        ...
        # prop_to_display='real',
        # split_view = True
        save_name = 'wall_1D_partial_reflexion_probability_density'
        )

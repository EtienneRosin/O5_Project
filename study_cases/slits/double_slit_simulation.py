...
from schrodinger_engine.potentials import DoubleSlit
...
slit_width = 0.5  # Width of the slit
slit_depth = 1  # Depth of the potentia
a = 1

sigma = a + 3 * slit_width
# sigma = 0.25
...
sim = PeriodicSchrodingerSimulation(
    ...
    potential=DoubleSlit(x_0=slit_position, width=slit_width, depth=slit_depth, a = a, V_0=V_0),
    overwrite = True,
